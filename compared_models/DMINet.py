...
class DMINet(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True,
                 pretrained=False, show_Feature_Maps=False):
    ...
    def forward(self, imgs1, imgs2=None, is_train=False):
        if imgs2 is None:
            imgs2 = imgs1
